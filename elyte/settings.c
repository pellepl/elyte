...
const setting_def_t defs[SETTING_COUNT_ALL] = {
    ...
    [SETTING_PRIVATE_PROFILE_VOLTAGE] = {.id = SETTING_PRIVATE_PROFILE_VOLTAGE,
                                         ...
                                         .e = -3,
                                         .tag = 0},
    [SETTING_PRIVATE_CALIB_I_K] = {.id = SETTING_PRIVATE_CALIB_I_K,
                                   .name = "Current gain",
                                   .descr = "Calibration gain for current measurement",
                                   .unit = "mA/V",
                                   .def = 1000,
                                   .max = 10000,
                                   .min = 100,
                                   .e = -3,
                                   .tag = 8},
    [SETTING_PRIVATE_CALIB_I_M] = {.id = SETTING_PRIVATE_CALIB_I_M,
                                   .name = "Current offset",
                                   .descr = "Calibration offset for current measurement",
                                   .unit = "mA",
                                   .def = 0,
                                   .max = 1000000,
                                   .min = -1000000,
                                   .e = -3,
                                   .tag = 9},
    [SETTING_PRIVATE_CALIB_V_K] = {.id = SETTING_PRIVATE_CALIB_V_K,
                                   .name = "Voltage gain",
                                   .descr = "Calibration gain for voltage measurement",
                                   .unit = "V/V",
                                   .def = 1000,
                                   .max = 10000,
                                   .min = 100,
                                   .e = -3,
                                   .tag = 10},
    [SETTING_PRIVATE_CALIB_V_M] = {.id = SETTING_PRIVATE_CALIB_V_M,
                                   .name = "Voltage offset",
                                   .descr = "Calibration offset for voltage measurement",
                                   .unit = "V",
                                   .def = 0,
                                   .max = 1000000,
                                   .min = -1000000,
