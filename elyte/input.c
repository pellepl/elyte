...
{
    input_button_t button = (input_button_t)(uintptr_t)arg;
    ...
    case EVENT_BUTTON_PRESS:
    {
        ...
        me.button_press_tick[but] = timer_now();
        break;
    }
    ...
    case EVENT_SECOND_TICK:
    {
        ...
        for (input_button_t but = 0; but < _INPUT_BUTTON_COUNT; but++)
        {
            ...
            if (!input_is_button_pressed(but) ||
                ...
                (now - me.button_press_tick[but] < TIMER_MS_TO_TICKS(INPUT_LONG_PRESS_SEC * 1000)) ||
